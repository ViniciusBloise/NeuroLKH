...
int BWTSP_Q;            /* Maximum number of subsequent white nodes in a
                                  BWTSP instance */ 
int BWTSP_L;            /* Maximum length of any path between two black
...
double DistanceLimit; /* Maxixim route distance for a CVRP instance */
int MaxMatrixDimension; /* Maximum dimension for an explicit
                                  cost matrix */
...
char *ParameterFileName, *ProblemFileName, *PiFileName,
            ...
            *MTSPSolutionFileName, *SINTEFSolutionFileName, *FeatFileName;
...
int* SavedD;
int GeneratingFeatures;
int NeuroLKH;
int GettingNodeDegree;
